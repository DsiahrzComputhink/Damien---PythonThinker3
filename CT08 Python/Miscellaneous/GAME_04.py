        ...
        if command.isnumeric():
            ...
            if int(command) == 2:
                ...
                if luck.isnumeric():
                    ...
                    print(style.bblue + "2" + style.RESET,"              ",fg("Windy [1/500]"))
                    print(style.bblue + "2" + style.RESET,"              ",fg("Snowy [1/600]"))
                    print(style.bblue + "3" + style.RESET,"             ",fg("Rainy [1/3000]"))
                    print(style.bblue + "2" + style.RESET,"         ",fg("Sandstorm [1/6666]"))
                    print(style.bblue + "2" + style.RESET,"          ",fg("Starfall [1/7500]"))
                    print(style.bblue + "2" + style.RESET,"        ",fg("Corruption [1/9000]"))
                    print(style.bblue + "2" + style.RESET,"             ",fg("Null [1/10100]"))
