...
def roll_for_aura(
    ...
    rolls: int = 1,
    rollspeed: int = 1,
    bonus_luck: float = 2.0, 
    bonus_roll_frequency: int = 10
):
    ListedAuras = {}
        ...
        if command.isnumeric():
            ...
            if int(command) == 2:
                ...
                if luck.isnumeric():
                    ...
                    print(style.bblue + "3" + style.RESET,"             ",fg("Rainy [1/3000]",39))
                    print(style.bblue + "4" + style.RESET,"         ",fg("Sandstorm [1/6666]",187))
                    print(style.bblue + "5" + style.RESET,"          ",fg("Starfall [1/7500]",75))
                    print(style.bblue + "6" + style.RESET,"        ",fg("Corruption [1/9000]",99))
                    print(style.bblue + "7" + style.RESET,"             ",fg("Null [1/10100]",249))
                    print(style.bblue + "8" + style.RESET,"         ",fg("Glitched [1/30000]",40))
                    print(LINE)
                    biome = input()
