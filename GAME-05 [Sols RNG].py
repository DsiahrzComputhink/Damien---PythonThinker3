...
Recipes["Starshaper"] = {
    ...
    Auras["Lost Soul"]["display"]: 5600,
    Auras["Flushed"]["display"]: 2700,
    Auras["Starlight"]["display"]: 1500, 
    Auras["Exotic"]["display"]: 1500,
    Auras["Bounded : Unbound"]["display"]: 200, 
